...
%% Power per band P3
P3PWR_delta = integral(P3XM(P3f > delta(1) & P3f < delta(2)), P3f(P3f > delta(1) & P3f < delta(2)));
P3PWR_teta = integral(P3XM(P3f > teta(1) & P3f < teta(2)), P3f(P3f > teta(1) & P3f < teta(2)));
P3PWR_alpha = integral(P3XM(P3f > alpha(1) & P3f < alpha(2)), P3f(P3f > alpha(1) & P3f < alpha(2)));
P3PWR_beta = integral(P3XM(P3f > beta(1) & P3f < beta(2)), P3f(P3f > beta(1) & P3f < beta(2)));
P3PWR_gama = integral(P3XM(P3f > gama(1) & P3f < gama(2)), P3f(P3f > gama(1) & P3f < gama(2)));
P3PWR_high_gama = integral(P3XM(P3f > high_gama(1) & P3f < high_gama(2)), P3f(P3f > high_gama(1) & P3f < high_gama(2)));

%% Power per band P4
P4PWR_delta = integral(P4XM(P4f > delta(1) & P4f > delta(2)), P4f(P4f > delta(1) & P4f > delta(2)));
P4PWR_teta = integral(P4XM(P4f > teta(1) & P4f > teta(2)), P4f(P4f > teta(1) & P4f > teta(2)));
P4PWR_alpha = integral(P4XM(P4f > alpha(1) & P4f > alpha(2)), P4f(P4f > alpha(1) & P4f > alpha(2)));
P4PWR_beta = integral(P4XM(P4f > beta(1) & P4f > beta(2)), P4f(P4f > beta(1) & P4f > beta(2)));
P4PWR_gama = integral(P4XM(P4f > gama(1) & P4f > gama(2)), P4f(P4f > gama(1) & P4f > gama(2)));
P4PWR_high_gama = integral(P4XM(P4f > high_gama(1) & P4f > high_gama(2)), P4f(P4f > high_gama(1) & P4f > high_gama(2)));
...
for ii=1:qntE
    P3EPWR_delta(ii) = integral(P3EXM(ii, index_delta), P3Ef(index_delta));
    P3EPWR_teta(ii) = integral(P3EXM(ii, index_teta), P3Ef(index_teta));
    P3EPWR_alpha(ii) = integral(P3EXM(ii, index_alpha), P3Ef(index_alpha));
    P3EPWR_beta(ii) = integral(P3EXM(ii, index_beta), P3Ef(index_beta));
    P3EPWR_gama(ii) = integral(P3EXM(ii, index_gama), P3Ef(index_gama));
    P3EPWR_high_gama(ii) = integral(P3EXM(ii, index_high_gama), P3Ef(index_high_gama));
end
...
for ii=1:qntE
    P4EPWR_delta(ii) = integral(P4EXM(ii, index_delta), P4Ef(index_delta));
    P4EPWR_teta(ii) = integral(P4EXM(ii, index_teta), P4Ef(index_teta));
    P4EPWR_alpha(ii) = integral(P4EXM(ii, index_alpha), P4Ef(index_alpha));
    P4EPWR_beta(ii) = integral(P4EXM(ii, index_beta), P4Ef(index_beta));
    P4EPWR_gama(ii) = integral(P4EXM(ii, index_gama), P4Ef(index_gama));
    P4EPWR_high_gama(ii) = integral(P4EXM(ii, index_high_gama), P4Ef(index_high_gama));
end
