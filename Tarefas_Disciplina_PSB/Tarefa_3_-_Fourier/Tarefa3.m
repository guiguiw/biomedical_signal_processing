...
%--------------------------------------------------------------------------
% TAREFA 3
%	Considere sinais artificiais da Tarefa 2, supondo Ta representativo do tempo de
%	amostragem [ms] e fa, a frequência de amostragem [Hz]. Todos os sinais tem duração de 0 a
%	10 ms. Considere o programa da transformada de Fourier, discutido na aula do 11/10/17.
%	Fazendo o uso do programa da aula do 11/10/17, estimar numericamente a transformada de
%	Fourier, a potência P e a frequência mediana fm dos sinais artificiais gerados na Parte 1 da
%	Tarefa 2. Cada grupo de estudantes deve considerar apenas o seu próprio sinal gerado.
%	Grupo1 por favor considere os dois casos separadamente.
% ETAPAS (Grupo1 por favor considere os dois casos separadamente)
%	1 Com os programas da parte 1 da Tarefa 2, cada grupo deve gerar pelo menos 10 vetores de
%		dados {X1, X2,...,X10}. Cada vetor deve ter um comprimento de 5000 amostras, e deve-se usar
...
%	2. Com a ajuda do programa de transformada de Fourier, calcular os vetores de dados
%		contendo o módulo da transformada normalizada {XN1, XN2,...,XN10} e a fase da transformada
%		{XFF1, XFF2,...,XFF10}. associados ao conjunto de sinais {X1, X2,...,X10}. Calcular também o
%		conjunto de potências {P1, P2,...,P10} e de frequências medianas {fm1, fm2,...,fm10}.
%		OBSERVAÇÃO IMPORTANTE: GRANDE CUIDADO deve ser tomado com o vetor de
%		frequências f, que contém todas as frequências do eixo, e que está estipulado pelo programa
%		da transformada de Fourier.
%	3. Plotar, num mesmo gráfico e utilizando escalas adequadas, os pares de vetores de dados
%		(t,Xi), (f,XNi); (f,XFFi), onde i = 1,...,10; considerando sempre o mesmo vetor f. Para cada
%		valor de i, fazer um gráfico de cores diferentes. Ou seja, devem ser geradas 3 figuras. Na
%		primeira figura, todos os 10 sinais no tempo serão mostrados com a mesma escala de tempo e
%		amplitude, enquanto que na segunda figura todos os módulos das 10 transformadas serão
%		apresentados com a mesma escala de frequência e potencia. O mesmo vale para a terceira
%		figura, onde todos os 10 graficos de fase da transformada serão apresentados com a mesma
%		escala de frequência e fase. Apresentar também uma tabela, onde os valores escalares de
%		potências {P1, P2,...,P10} serão mostrados numa coluna, os valores escalares de frequências
%		medianas {fm1, fm2,...,fm10} serão mostrados na segunda coluna, e os valores dos
%		parâmetros característicos dos sinais Xi serão mostrados na terceira coluna.
%		Discutir a variação da forma dos gráficos em função dos parâmetros do sinal X, e também
%		confrontar os resultados da tabela com estes gráficos.
%	Deverão ser enviados por email o programa .m gerado na parte 1, devidamente
%	documentado (separação das diversas partes, listas de variáveis de entrada e de saída),
%	os gráficos e tabela solicitados na parte 2. Estes mesmos programas, gráficos e tabela
%	deverão ser apresentados na aula de discussão desta tarefa, agendada para o dia
%	08/11/17.
%-------------------------------------------------------------------------- 
